...
static inline int do_stune_boost(int boost, int *slot)
{
	return 0;
}

static inline int do_stune_sched_boost(int *slot)
{
	return 0;
}

static inline int reset_stune_boost(int slot)
{
	return 0;
}

static inline int do_prefer_idle(u64 prefer_idle)
{
	return 0;
}

static inline int get_sched_boost(void)
{
	return 0;
}
